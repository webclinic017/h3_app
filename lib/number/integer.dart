...
class Integer extends Number {
  ...
  @override
  Number operator %(Number other) => (other is Decimal) ? Decimal.fromInt(value) % other : new Integer(value % (other as Integer).value);
  ...
  @override
  Integer operator ~/(Number other) => (other is Decimal) ? Decimal.fromInt(value) ~/ other : new Integer(value ~/ (other as Integer).value);
  ...
  @override
  Number remainder(Number other) => (other is Decimal) ? Decimal.fromInt(value).remainder(other) : new Integer(value.remainder((other as Integer).value));
  ...
  @override
  String toStringAsExponential([int fractionDigits]) => Decimal.fromInt(value).toStringAsExponential(fractionDigits);

  @override
  String toStringAsFixed(int fractionDigits) => Decimal.fromInt(value).toStringAsFixed(fractionDigits);

  @override
  String toStringAsPrecision(int precision) => Decimal.fromInt(value).toStringAsPrecision(precision);
