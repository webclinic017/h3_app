...
class LeShuaPaymentResult {
  ...
  factory LeShuaPaymentResult.fromXml(String xmlString) {
    ...
    return LeShuaPaymentResult.fromJson(map);
  }

  factory LeShuaPaymentResult.fromJson(Map<String, dynamic> map) {
    return LeShuaPaymentResult()
