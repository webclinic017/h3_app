...
class StoreMake extends BaseEntity {
  ///表名称
  static final String tableName = "pos_store_make";
  ...
  ///Map转实体对象
  factory StoreMake.fromMap(Map<String, dynamic> map) {
    return StoreMake()
      ..id = Convert.toStr(
  ...
  static List<StoreMake> toList(List<Map<String, dynamic>> lists) {
    var result = new List<StoreMake>();
    lists.forEach((map) => result.add(StoreMake.fromMap(map)));
    return result;
  }
