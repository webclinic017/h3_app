...
class KdsPlan extends BaseEntity {
  ///表名称
  static final String tableName = "pos_kds_plan";
  ...
  ///Map转实体对象
  factory KdsPlan.fromMap(Map<String, dynamic> map) {
    return KdsPlan()
      ..id = Convert.toStr(
  ...
  static List<KdsPlan> toList(List<Map<String, dynamic>> lists) {
    var result = new List<KdsPlan>();
    lists.forEach((map) => result.add(KdsPlan.fromMap(map)));
    return result;
  }
