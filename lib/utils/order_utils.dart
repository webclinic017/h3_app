...
//           FLogger.info("参与折扣的数量<$effectiveQuantity>,折扣率<${promotion.discountRate}>");
...
//           FLogger.info("参与议价的数量<$effectiveQuantity>,议价金额<${promotion.bargainPrice}>");
...
//     List<Module> result = new List<Module>();
//     try {
//       String sql = sprintf("select id,tenantId,area,name,alias,keycode,keydata,color1,color2,color3,color4,fontSize,shortcut,orderNo,icon,enable,permission,createUser,createDate,modifyUser,modifyDate from pos_module where area = '%s' order by orderNo asc;", ["快捷"]);
//       var database = await SqlUtils.instance.open();
//       List<Map<String, dynamic>> lists = await database.rawQuery(sql);
...
//     List<Module> result = new List<Module>();
//     try {
//       String sql = sprintf("select id,tenantId,area,name,alias,keycode,keydata,color1,color2,color3,color4,fontSize,shortcut,orderNo,icon,enable,permission,createUser,createDate,modifyUser,modifyDate from pos_module where area = '%s' order by orderNo asc;", ["更多"]);
//       var database = await SqlUtils.instance.open();
//       List<Map<String, dynamic>> lists = await database.rawQuery(sql);
