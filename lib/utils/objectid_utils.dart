...
class ObjectIdUtils {
  ...
  ///工厂模式
  factory ObjectIdUtils() => getInstance();
  static ObjectIdUtils _instance;

  final idGenerator = IdGenerator();

  static ObjectIdUtils getInstance() {
    if (_instance == null) {
      _instance = ObjectIdUtils._internal();
    }
    return _instance;
  }

  ObjectIdUtils._internal();
  ...
  String generateReadable({String separator = '-'}) {
    return idGenerator.generateReadable(separator:separator);
  }
